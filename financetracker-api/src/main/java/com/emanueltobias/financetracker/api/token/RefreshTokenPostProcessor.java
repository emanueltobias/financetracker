package com.emanueltobias.financetracker.api.token;
...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken>{
	...
	@Autowired
	private FinancetrackerApiProperty financetrackerApiProperty;
	...
	private void adicionarRefreshTokenCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
		...
		refreshTokenCookie.setSecure(financetrackerApiProperty.getSeguranca().isEnableHttps());
